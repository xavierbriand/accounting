...
Frozen 2026-08-14 at tag [`v0.1`](https://github.com/xavierbriand/sluice/tree/v0.1). It ran Feb–Aug 2026 and produced 7,256 LOC of well-layered TypeScript, 1,085 tests, and a product that was never used once on real data. Roughly 72% of its story volume was process rather than product.
