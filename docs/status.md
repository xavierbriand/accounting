...
- **Next (user's pick):** **Epic 5** (Year-in-Review & Annual Planner — fully unblocked; Stories 5.1 / 5.2a / 5.2b / 5.3 read-only, 5.4's `ConfigChanged` dependency shipped in 4.5a — see [epics.md](epics.md)) · restore-from-bundle ([#232](https://github.com/xavierbriand/accounting/issues/232)) · Module 6 teach-out, now unblocked ([#100](https://github.com/xavierbriand/accounting/issues/100)).
